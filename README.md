...
| `header_background` | Theme Tweaker/Home Assistant header background | Dock/header background color. Overrides `background` when set. |
| `background` | Theme Tweaker/Home Assistant header background | Legacy alias for `header_background`. |
